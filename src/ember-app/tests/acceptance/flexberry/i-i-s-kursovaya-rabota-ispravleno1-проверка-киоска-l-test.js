...
moduleForAcceptance('[AGAT] Acceptance | i i s kursovaya rabota ispravleno1 проверка киоска l');

test('testing i-i-s-kursovaya-rabota-ispravleno1-проверка-киоска-l', function(assert) {
