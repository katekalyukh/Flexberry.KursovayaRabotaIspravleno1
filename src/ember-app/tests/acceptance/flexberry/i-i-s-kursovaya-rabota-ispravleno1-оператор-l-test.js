...
moduleForAcceptance('[AGAT] Acceptance | i i s kursovaya rabota ispravleno1 оператор l');

test('testing i-i-s-kursovaya-rabota-ispravleno1-оператор-l', function(assert) {
