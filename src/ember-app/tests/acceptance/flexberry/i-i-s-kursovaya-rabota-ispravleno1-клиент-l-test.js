...
moduleForAcceptance('[AGAT] Acceptance | i i s kursovaya rabota ispravleno1 клиент l');

test('testing i-i-s-kursovaya-rabota-ispravleno1-клиент-l', function(assert) {
