...
moduleForAcceptance('[AGAT] Acceptance | i i s kursovaya rabota ispravleno1 товары l');

test('testing i-i-s-kursovaya-rabota-ispravleno1-товары-l', function(assert) {
