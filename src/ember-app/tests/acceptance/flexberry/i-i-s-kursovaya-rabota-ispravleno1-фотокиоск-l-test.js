...
moduleForAcceptance('[AGAT] Acceptance | i i s kursovaya rabota ispravleno1 фотокиоск l');

test('testing i-i-s-kursovaya-rabota-ispravleno1-фотокиоск-l', function(assert) {
