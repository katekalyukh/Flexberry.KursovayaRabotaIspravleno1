...
namespace IIS.KursovayaRabotaIspravleno1
{
    ...
    [AssociatedDetailViewAttribute("ЗаказE", "Фото", "ФотоL", false, "", "Фото", true, new string[] {
            ""})]
    ...
    public class Заказ : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.KursovayaRabotaIspravleno1.ВидНосителя fНоситель;
        
        private IIS.KursovayaRabotaIspravleno1.Фотокиоск fФотокиоск;
        
        private IIS.KursovayaRabotaIspravleno1.Клиент fКлиент;
        
        private IIS.KursovayaRabotaIspravleno1.DetailArrayOfФото fФото;
        ...
        public virtual IIS.KursovayaRabotaIspravleno1.ВидНосителя Носитель
        {
            get
            {
                ...
                IIS.KursovayaRabotaIspravleno1.ВидНосителя result = this.fНоситель;
        ...
        [PropertyStorage(new string[] {
                "Клиент"})]
        [NotNull()]
        public virtual IIS.KursovayaRabotaIspravleno1.Клиент Клиент
        {
            get
            {
                ...
                IIS.KursovayaRabotaIspravleno1.Клиент result = this.fКлиент;
        ...
        [PropertyStorage(new string[] {
                "Фотокиоск"})]
        [NotNull()]
        public virtual IIS.KursovayaRabotaIspravleno1.Фотокиоск Фотокиоск
        {
            get
            {
                ...
                IIS.KursovayaRabotaIspravleno1.Фотокиоск result = this.fФотокиоск;
        ...
        public virtual IIS.KursovayaRabotaIspravleno1.DetailArrayOfФото Фото
        {
            get
            {
                ...
                if ((this.fФото == null))
                {
                    this.fФото = new IIS.KursovayaRabotaIspravleno1.DetailArrayOfФото(this);
                }
                IIS.KursovayaRabotaIspravleno1.DetailArrayOfФото result = this.fФото;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ЗаказE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ЗаказE", typeof(IIS.KursovayaRabotaIspravleno1.Заказ));
                }
            }
            ...
            public static ICSSoft.STORMNET.View ЗаказL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ЗаказL", typeof(IIS.KursovayaRabotaIspravleno1.Заказ));
                }
            }
        }
    }
