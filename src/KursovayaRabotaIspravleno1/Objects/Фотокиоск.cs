...
namespace IIS.KursovayaRabotaIspravleno1
{
    ...
    public class Фотокиоск : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.KursovayaRabotaIspravleno1.Товары fТовары;
        ...
        /// Фотокиоск.
        /// </summary>
        // *** Start programmer edit section *** (Фотокиоск.Товары CustomAttributes)

        // *** End programmer edit section *** (Фотокиоск.Товары CustomAttributes)
        [PropertyStorage(new string[] {
                "Товары"})]
        [NotNull()]
        public virtual IIS.KursovayaRabotaIspravleno1.Товары Товары
        {
            get
            {
                // *** Start programmer edit section *** (Фотокиоск.Товары Get start)

                // *** End programmer edit section *** (Фотокиоск.Товары Get start)
                IIS.KursovayaRabotaIspravleno1.Товары result = this.fТовары;
                // *** Start programmer edit section *** (Фотокиоск.Товары Get end)

                // *** End programmer edit section *** (Фотокиоск.Товары Get end)
                return result;
            }
            set
            {
                // *** Start programmer edit section *** (Фотокиоск.Товары Set start)

                // *** End programmer edit section *** (Фотокиоск.Товары Set start)
                this.fТовары = value;
                // *** Start programmer edit section *** (Фотокиоск.Товары Set end)

                // *** End programmer edit section *** (Фотокиоск.Товары Set end)
            }
        }
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ФотокиоскE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ФотокиоскE", typeof(IIS.KursovayaRabotaIspravleno1.Фотокиоск));
                }
            }
            ...
            public static ICSSoft.STORMNET.View ФотокиоскL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ФотокиоскL", typeof(IIS.KursovayaRabotaIspravleno1.Фотокиоск));
                }
            }
        }
    }
